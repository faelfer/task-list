...
- [x] Open the [Task List GitHub page](https://github.com/NYDino/task-list) and click the ★ Star and then ⑂ Fork buttons.
- [x] Clone a copy to your local machine with `$ git clone git@github.com:YOUR-GITHUB-USER-NAME/task-list`.
...
- [x] Visit your fork on GitHub.com ([https://github.com/YOUR-USER-NAME/task-list](https://github.com/YOUR-USER-NAME/task-list)) and create a pull request for your changes.
...
Bugs are tracked as [GitHub issues](https://github.com/NYDino/task-list/issues). If you found a bug with xplore, the quickest way to get help would be to look through existing open and closed [GitHub issues](https://github.com/NYDino/task-list/issues/issues?q=is%3Aissue). If the issue is already being discussed and hasn't been resolved yet, you can join the discussion and provide details about the problem you are having. If this is a new bug, please open a [new issue](https://github.com/NYDino/task-list/issues/new).
...
We track discussions of new features, proposed changes, and other ideas as [GitHub issues](https://github.com/NYDino/task-list/issues). If you would like to discuss one of those, please first look through existing open and closed [GitHub issues](https://github.com/NYDino/task-list/issues?q=is%3Aissue) and see if there is already a discussion on this topic which you can join. If there isn't, please open a [new issue](https://github.com/NYDino/task-list/issues/new).
